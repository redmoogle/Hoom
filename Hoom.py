        ...
        while(True):
            ...
            if(HP < 100):
                ...
                if(HPGainPart >= 10):
                    ...
                    while(HPGainPart != 0) and (MaxHeal != 0):
                        print("Half Exec")
                        time.sleep(1)
                        HPGain += 1
                        HPGainPart += 1
            ...
            try:
                Vars = [HP, GameOut[1], GameOut[2], ActOut[8][0], ActOut[0], ActOut[1], ActOut[2], GameOut[3], GameOut[4], ActOut[5][2], ActOut[5][3], ActOut[5][4], GameOut[5], GameOut[6], GameOut[7], GameOut[8], GameOut[9], ActOut[7]]
            except:
                Vars = [HP, GameOut[1], GameOut[2], Vars[3], ActOut[0], ActOut[1], ActOut[2], GameOut[3], GameOut[4], ActOut[5][2], ActOut[5][3], ActOut[5][4], GameOut[5], GameOut[6], GameOut[7], GameOut[8], GameOut[9], ActOut[7]]
